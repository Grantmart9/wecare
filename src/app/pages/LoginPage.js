...
const LoginForm = ({ loginData, handleLoginChange, handleLogin, loading, showPassword, setShowPassword }) => (
    <motion.div
        key="login-form"
...
const RegisterForm = ({ registerData, handleRegisterChange, handleRegister, loading, showPassword, setShowPassword, showConfirmPassword, setShowConfirmPassword }) => (
    <motion.div
        key="register-form"
        initial={{ opacity: 0, x: 20 }}
        animate={{ opacity: 1, x: 0 }}
...
const ForgotPasswordForm = ({ forgotEmail, setForgotEmail, handleForgotPassword, loading }) => (
    <motion.div
        key="forgot-form"
...
const LoginPage = ({ handlePage, scrollToTop }) => {
    ...
    return (
        <div className={`min-h-screen theme-bg-secondary transition-colors duration-300 ${themeMode === 'dark' ? 'dark' : ''}`}>
            ...
            <motion.div
                ...
                className="bg-gradient-to-r from-blue-600 to-purple-700 py-8 text-center"
            >
